...
class StrategySameLevel implements StrategyInterface
{
    ...
    private function plan(TaskEntity $task, DeveloperEntity $developer, int $week = 1)
    {
        ...
        if ($developer->taskEffort($task) + $this->calculateOccupiedHours($weekDetails, $developer) > AssignStrategyContext::WORKING_HOURS) {
